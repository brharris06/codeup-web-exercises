...
function analyzeColor(color) {
    if (color === 'blue') {
        ...
        return 'I dont know anything about that color ' + color;
    }
}
...
// //  - `colors`: a list of the colors of the rainbow- `randomColor`: contains a single random color value from the list (this
...
//
//     if (typeof Number(numInput === 'number') {
//             // alert even/odd messages...
//         if
//
//         alert (numInput / 2 === 0 );
//
